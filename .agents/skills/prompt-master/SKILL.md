---
name: prompt-master
description: Use when the user explicitly asks to write, fix, improve, adapt, or audit a prompt for a named AI tool or model such as ChatGPT, Claude, Codex, Cursor, Midjourney, Sora, or an agentic IDE. Do not use for executing the requested task, general conversation, coding, document writing, or merely organizing rough notes without tool-specific optimization.
---
