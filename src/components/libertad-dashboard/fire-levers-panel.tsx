  ...
  return (
    <section className="libertad-surface rounded-lg p-5 sm:p-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-3xl text-sm leading-6 text-stone-600">
            Muestra cuanto capital productivo necesitarias para sostener tus
            gastos confirmados sin depender de trabajo activo. La regla es gasto
            mensual x 12 x 25.
          </p>
        </div>
        <div className="rounded-md border border-emerald-100 bg-emerald-50 px-3 py-2 text-sm text-emerald-950">
          Es capital necesario, no gasto anual.
        </div>
      </div>
      ...
      <div className="libertad-card-grid mt-5 grid gap-3">
        ...
        />
        <MetricCard
          label="Capital necesario para estos gastos"
          value={currencyFormatter.format(summary.confirmedFireNumber)}
          detail="Capital invertido aproximado para cubrir los gastos anuales actuales sin trabajar."
          tone="green"
        />
      </div>
